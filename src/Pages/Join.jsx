    ...
    <>
      <div className="background-container">
        ...
        <div   className="switch-container">
          <div onClick={navigateHandler} style={{cursor:'pointer'}} className="logo_container">
            ...
            <div className="col">
              <div className="d-flex justify-content-center">
                <p className="join_title">
                  ...
                  <span style={{ color: "#CB6CE6" }}>PurposeFindr'</span>s
                  AI-enabled Software that redefines job hunting and recruitment
                </p>
              </div>
              <div className="d-flex justify-content-center join_input">
                <form action="">
                  ...
                  <label htmlFor="" className="label_style input_label_body">
                    Email address
                  </label>
                  <div className="position-relative">
                    <span className="icon_style">
              ...
              <p
                className="footer_copyright m-0"
                style={{ paddingTop: "56px", fontSize: "12px" }}
              >
