                    ...
                    <div className="row hows_top">
                        <div className="col" data-aos="fade-down">
                            ...
                            <div className='d-flex justify-content-center'>
                                <p className='how_subheader m-0'>Let us take you through the ‘HOW’ of our mobile app, if you would like to see a demo you can book one below.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col d-none d-sm-none d-md-none d-lg-block d-xl-block d-xxl-block">
                            <div className="row box_content">
                                <div className="col-lg-6" data-aos="fade-top">
                                    <p className='how_title m-0'>1. Create your profile & set preferences</p>
                                    <p className='how_subtitle m-0 pt-2'><ul className='m-0 ps-4'><li>
                                        Discover tailored opportunities
                                    </li></ul> </p>
                                    <p className='how_subtitle m-0 pt-2'>
                                        <ul className='m-0 ps-4'><li>
                                            Get matched swiftly & apply
                                        </li></ul> </p>
                                    <p className='how_subtitle m-0 pt-2'><ul className='m-0 ps-4'><li>
                                        Track progress & land your role
                                    </li></ul> </p>
                                </div>
                                <div className="col-lg-6 box_three">
                                    <div className='how_box position-relative' data-aos="fade-down">
                            ...
                            <div className="row box_content">
                                ...
                                <div className="col-lg-6 search_content" data-aos="fade-top">
                                    <div className='hows_builetss'>
                                        <p className='how_subtitle m-0'><ul className='m-0 ps-4'><li>
                                            Create your profile & set preferences
                                        </li></ul> </p>
                                    <p className='how_title m-0 pt-2'>2. Discover tailored opportunities</p>
                                    <p className='how_subtitle m-0 pt-2'><ul className='m-0 ps-4'><li>
                                            Get matched swiftly & apply
                                        </li></ul> </p>
                                        <p className='how_subtitle m-0 pt-2'><ul className='m-0 ps-4'><li>
                        ...
                        <div className="col d-none d-sm-none d-md-none d-lg-block d-xl-block d-xxl-block">
                            <div className="row box_content">
                                <div className="col-lg-6" data-aos="fade-top">
                                    ...
                                    <p className='how_title m-0'>3. Get matched swiftly & apply</p>
                                    <p className='how_subtitle m-0'><ul className='m-0 ps-4'><li>
                                        Track progress & land your role
                                    </li></ul> </p>
                                </div>
                        ...
                        <div className="col d-block d-sm-block d-md-block d-lg-none d-xl-none d-xxl-none">
                            <div className="row box_content">
                                ...
                                <div className="col-lg-6 search_content" data-aos="fade-top">
                                    ...
                                    <p className='how_title m-0 pt-2'>3. Get matched swiftly & apply</p>
                                    <p className='how_subtitle m-0 pt-2'><ul className='m-0 ps-4'><li>
                                            Track progress & land your role
                                        </li></ul> </p>
                                    </div>
                        ...
                        <div className="col">
                            <div className="row box_content">
                                ...
                                <div className="col-lg-6 search_content" data-aos="fade-top">
                                    ...
                                    <p className='how_title m-0 pt-2'>4. Track progress & land your role</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="row">
                    <div className="col p-0">
                            <div className='be_style position-relative'>
                                <img src={Groupone} alt="" className='bg_be_img d-block d-sm-none d-md-none d-lg-none d-xl-none d-xxl-none'/>
                                <p className='be_title m-0'>Be one of the first users of PurposeFindr's <br /> AI-enabled software that redefines job <br /> hunting and recruitment.</p>
                                <button className='join_how_btn' style={{ cursor: "pointer" }} onClick={handleButtonClick}>
